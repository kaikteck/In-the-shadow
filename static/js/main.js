    ...
    if (e.target.closest('.delete-btn')) {
        ...
        modal.innerHTML = `
            <div class="modal-content">
                ...
                <p>Tem certeza que deseja remover este exemplo? Esta ação não pode ser desfeita.</p>
        ...
        modal.querySelector('.confirm-btn').addEventListener('click', () => {
            // For static site, trigger delete function instead of navigation
            const deleteId = deleteBtn.dataset.deleteId;
            if (deleteId && typeof deleteExample === 'function') {
